...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "js-to-html", "like-ar", "typed-controls", "dialog-promise", "best-globals", "myOwn"], factory);
    }
    ...
    var tipoc_BF = /** @class */ (function (_super) {
        ...
        tipoc_BF.prototype.adaptOptionInput = function (groupElement) {
            ...
            var completarTablaResumen = function completarTablaResumen(table, formData, navigationButton, maxFieldsCount, mostrarUnidadesAnalisisEnResumen, searchFormId) {
                ...
                /*var searchInfoCasilleroByFormIdInStructure = function searchInfoCasilleroByFormIdInStructure(mainStructure: SurveyStructure, formId:string):InfoCasillero{
                    console.log("mainStructure: ", mainStructure)
                    return Object.values(mainStructure).find(function (infoCasillero){
                        return infoCasillero.data.casillero === formId;
                    });
                }*/
                        ...
                        if (mostrarUnidadesAnalisisEnResumen) {
                            ...
                            if (formData[key].length) {
                                formData[key].forEach(function (childFormData, index) {
                                    ...
                                    //var infoCasillero = searchInfoCasilleroByFormIdInStructure(myForm.surveyManager.surveyMetadata.structure, searchFormId)
