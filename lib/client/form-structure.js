...
(function (factory) {
    ...
    var OPEN_IN_OTHER_SCREEN = false;
    ...
    var tipoc_BF = /** @class */ (function (_super) {
        ...
        tipoc_BF.prototype.adaptOptionInput = function (groupElement) {
            ...
            var completarTablaResumen = function completarTablaResumen(table, formData, navigationButton, maxFieldsCount, mostrarUnidadesAnalisisEnResumen, formId, iPosition) {
                var thArray = [];
                    ...
                    if (Array.isArray(formData[key])) {
                        ...
                        if (thArray.filter(function (th) { return th.getAttribute('element-type') === 'question'; }).length < maxFieldsCount) {
                            ...
                            if (infoCasillero) {
                                ...
                                tdArray.push(js_to_html_1.html.td({ id: 'resumen-' + formId + '-' + (iPosition + 1).toString() + '-' + key, class: 'col' }, respuesta).create());
                            }
                        }
                    }
                });
