...
(function (factory) {
    ...
    var tipoc_F = /** @class */ (function (_super) {
        ...
        tipoc_F.prototype.displayRef = function (opts) {
            ...
            if (myForm.back.pilaDeRetroceso.length) {
                var button = js_to_html_1.html.button({ class: 'boton-formulario' }, "Volver al " + myForm.back.pilaDeRetroceso[0].formIdParaRetroceder).create();
    ...
    var tipoc_BF = /** @class */ (function (_super) {
        ...
        tipoc_BF.prototype.adaptOptionInput = function (groupElement) {
            ...
            var myForm = this.myForm;
            var loadForm = function loadForm(formName, rowHijo, UAdelForm, iPosicional, myForm) {
    ...
    var FormStructure = /** @class */ (function () {
        function FormStructure(surveyStructure, depot, mainFormId, pilaDeRetroceso) {
            if (pilaDeRetroceso === void 0) { pilaDeRetroceso = []; }
        ...
        FormStructure.prototype.addToStack = function (pilaDeRetroceso) {
