...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "js-to-html", "like-ar", "typed-controls", "dialog-promise", "./form-types", "myOwn"], factory);
    }
    ...
    var tipoc_Base = /** @class */ (function () {
        ...
        tipoc_Base.prototype.displayInput = function (direct) {
            ...
            if (!form_types_1.formTypes[this.data.tipovar]) {
                throw new Error(this.data.tipovar + ' no existe como tipo');
            }
            if (form_types_1.formTypes[this.data.tipovar].radio) {
                return undefined;
            }
            var control = js_to_html_1.html.input({
                "tipo-var": this.data.tipovar || 'unknown',
                "longitud-var": this.data.longitud || 'unknown',
                "type": form_types_1.formTypes[this.data.tipovar].htmlType,
            }).create();
            TypedControls.adaptElement(control, form_types_1.formTypes[this.data.tipovar]);
            this.myForm.variables[this.var_name] = {
                ...
                tipo: form_types_1.formTypes[this.data.tipovar].validar,
                maximo: null,
                minimo: null,
        ...
        tipoc_Base.prototype.displayInputForOptions = function () {
            ...
            if (form_types_1.formTypes[this.data.tipovar].htmlType == 'number') {
                inputAttr["min"] = '1';
        ...
        tipoc_Base.prototype.createVariable = function () {
            if ((form_types_1.formTypes[this.data.tipovar] || { radio: false }).radio) {
                var opciones = {};
    ...
    var tipoc_BF = /** @class */ (function (_super) {
        ...
        tipoc_BF.prototype.adaptOptionInput = function (groupElement) {
            ...
            var completarTablaResumen = function completarTablaResumen(table, formData, navigationButton) {
                var thArray = [];
