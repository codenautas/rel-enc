...
(function (factory) {
    ...
    var tipoc_F = /** @class */ (function (_super) {
        ...
        tipoc_F.prototype.displayRef = function (opts) {
            ...
            if (myForm.stackLength()) {
                var button = js_to_html_1.html.button({ class: 'boton-formulario' }, "Volver al " + myForm.getFirstFromStack().formIdParaRetroceder).create();
    ...
    var tipoc_BF = /** @class */ (function (_super) {
        ...
        tipoc_BF.prototype.adaptOptionInput = function (groupElement) {
            ...
            var myForm = this.myForm;
            var loadForm = function loadForm(formId, formData, UAdelForm, iPosicional, myForm) {
                ...
                Object.keys(formData).forEach(function (key) {
                    if (Array.isArray(formData[key])) {
                        ...
                        if (formData[key].length) {
                            formData[key].forEach(function (child, index) {
                        ...
                        if (infoCasillero.childs.length) {
                            var result = infoCasillero.childs.find(function (option) {
                                var id_casillero = (formData[key] || '').toString();
            ...
            if (myForm.formData[UAdelForm]) {
                ...
                myForm.formData[UAdelForm].forEach(function (rowHijo, iPosicional) {
    ...
    var FormManager = /** @class */ (function () {
        ...
        FormManager.prototype.JsonConcatPath = function (object1, object2, UAPath) {
